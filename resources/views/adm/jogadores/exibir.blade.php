          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="x_panel">
                  <div class="x_title">
                    <a style="float:left" href="{{url('adm/jogadores/cadastrar')}}" class="btn btn-success btn-xs"> <h2>Cadastrar novo Jogador +</h2> </a>
                    <a style="float:right" href="{{url('adm/jogadores/export')}}" class="btn btn-primary btn-md"><h2><i class="fa fa-file-excel-o"></i> Exportar para Excel</h2> </a>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
